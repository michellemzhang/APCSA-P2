...
public class OuterSpace extends Canvas implements KeyListener, Runnable
{
	...
	public OuterSpace()
	{
		...
		//alienOne = new Alien(400, 200, 55, 30, 1);
		//alienTwo = new Alien(450, 200, 55, 30, 1);
		shots = new Bullets();
		horde = new AlienHorde(20);
		shots.add(new Ammo(-10, -10, 0));
		extension = new Extension(200, 500, 50, 50, 2);	
		game = true;
   ...
   public void update(Graphics window)
   {
	...
	public void paint( Graphics window )
	{
		...
		if (keys[4] == true)
		{
			...
			shots.add(new Ammo((extension.getX() + extension.getWidth() / 2), extension.getY() - 5, 5));
			shots.moveEmAll();
			keys[4] = false;
